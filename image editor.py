...
btn=Button(root,text="Open Image",font= ("Algerian", 12),bg="white",fg="black", command=openFile, relief=SOLID, padx=15, pady=10)
btn.place(relx=0.5,rely=0.1,anchor=CENTER)

btn1=Button(root,text="Rotate Image",font= ("Algerian", 12),bg="white",fg="black", command=rotateImage, relief=SOLID, padx=15, pady=10)
